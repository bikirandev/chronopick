...
const TimePicker: React.FC<TimePickerProps> = ({
  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-200 dark:border-slate-700">
      ...
      <p
        id={timePickerLabelId}
        className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-2 text-center"
      >
        Select Time
      </p>
      ...
      >
        <select
          ...
          } // Pass undefined for minute if only hour changes
        ...
        <span className="text-gray-500 dark:text-slate-400" aria-hidden="true">
          :
        </span>{" "}
        {/* Visual separator */}
        <select
          ...
          } // Pass undefined for hour if only minute changes
          className="p-2 border border-gray-300 dark:border-slate-600 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 dark:text-slate-200"
